...
export default function CartDrawer() {
  ...
  return (
    <div className="p-4 border-l w-80 fixed right-0 top-0 h-full bg-white dark:bg-gray-800 shadow-lg">
      ...
      <Link href="/cart" className="block mt-4 bg-blue-600 text-white text-center py-2">Checkout</Link>
      <button className="mt-2 text-sm underline" onClick={clear}>Clear</button>
    </div>
  );
}
